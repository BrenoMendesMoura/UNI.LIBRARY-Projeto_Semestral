...
<div class="modal-dialog modal-xl">
  <div class="modal-content">
    ...
    <div class="modal-body text-center">
      <img src="${anime.images.jpg.large_image_url}" style="width: 25rem; height: 25rem;" class="card-img-center rounded-4 btn-transparent bg-transparent border-transparent mb-5 text-center" alt="...">
    </div>
            ...
            .map(manga=>{
              ...
              <div class="modal-dialog modal-xl">
                <div class="modal-content">
                  ...
                  <div class="modal-body text-center">
                    <img src="${manga.images.jpg.large_image_url}" style="width: 25rem; height: 25rem;" class="card-img-center rounded-4 btn-transparent bg-transparent border-transparent mb-5 text-center" alt="...">
                  </div>
